...
void Skill::setColor(ElementType type)
{
    switch (type)
    {
        ...
        case ElementType::Wood:
            ...
            _effect->setStartColorVar(Color4F(0.0f, 0.1f, 0.1f, 0.0f));
            break;
